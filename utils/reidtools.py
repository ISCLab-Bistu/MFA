...
def visualize_ranked_results(
    distmat, dataset, num_query, data_type, width=128, height=256, save_dir='', topk=10
):
    ...
    gallery = dataset.dataset.dataset[num_query:]
    query = dataset.dataset.dataset[:num_query]
